...
DO ITIME = 1, NTIME
  ...
  CALL CUCALLN_MF_MANYBLOCKS (PPLDARE, PPLRG, KSTEP, YDTHF, YDCST, YDERAD, YDML_PHY_SLIN, YDML_PHY_EC, &
      & YGFL, YDCHEM, YDSPP_CONFIG, YDPERTPAR, IIDIA, IFDIA, KLON, KSMAX, KLEV, PDX, KSPPN2D, LDMCAPEA, &
      ...
      & PVDISCU, PDISS, KTRAC, PCM1, PTENC, PSCAV, PSCAV0=PSCAV0, LDACC=LLACC, YDOFFSET=YLOFFSET, KGPBLKS=NGPBLKS)
...
IF (.NOT. LLEXIST) &
WRITE (IOUT, '(A16,";",A8,";",A8,";",A8,5(";",A20),";",A32)') &
              & "CLARCH", "NPROMA", "NGPBLKS", "NTIME", &
              & "ZTCTOT", "ZTC", "ZTDTOT", "ZTD", "METHOD"

WRITE (IOUT, '(A16,";",I8,";",I8,";",I8,4(";",E20.10),";",A32)') &
              & CLARCH,  NPROMA, NGPBLKS, NTIME, &
