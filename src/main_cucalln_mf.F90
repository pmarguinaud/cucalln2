...
!$ACC          & PDX, LDLAND, PTM1, PQM1, PUM1, PVM1, PLITOT, PVERVEL, PQHFL, PAHFS, PAPHM1, PAP, PAPH, &
!$ACC          & PGEO, PGEOH, PGAW, PCUCONVCA, PGP2DSPP, PTENT, PTENQ, PTENU, PTENV, PTENTA, PTENQA, &
!$ACC          & PARPRC, KTOPC, KBASEC, KTYPE, KCBOT, KCTOP, KBOTSC, LDCUM, LDSC, KCBOT_LIG, KCTOP_LIG, &
!$ACC          & LDCUM_LIG, LDSHCV, PLCRIT_AER, PLU, PLUDE, PLUDELI, PSNDE, PMFU, PMFD, PLGLAC, PDIFCQ, &
!$ACC          & PDIFCS, PFHPCL, PFHPCN, PFPLCL, PFPLCN, PLRAIN, PRSUD, PSTRCU, PSTRCV, PFCQLF, PFCQIF, &
!$ACC          & PMFUDE_RATE, PMFDDE_RATE, PCAPE, PWU, PWMEAN, PVDISCU, PDISS, PCM1, PTENC)

CALL YDTHF%ACDC_COPY ()
CALL YDCST%ACDC_COPY ()
CALL YDERAD%ACDC_COPY ()
CALL YDML_PHY_SLIN%ACDC_COPY ()
CALL YDML_PHY_EC%ACDC_COPY ()
CALL YGFL%ACDC_COPY ()
CALL YDCHEM%ACDC_COPY ()
CALL YDSPP_CONFIG%ACDC_COPY ()
CALL YDPERTPAR%ACDC_COPY ()
...
!$ACC SERIAL PRESENT (YSTACK)
YLSTACKBASE%L4 = LOC (YSTACK%ZDATA4 (1, 1, 1, 1))
YLSTACKBASE%U4 = YLSTACKBASE%L4 + SIZE (YSTACK%ZDATA4) * KIND (YSTACK%ZDATA4)
YLSTACKBASE%L8 = LOC (YSTACK%ZDATA8 (1, 1, 1, 1))
YLSTACKBASE%U8 = YLSTACKBASE%L8 + SIZE (YSTACK%ZDATA8) * KIND (YSTACK%ZDATA8)
!$ACC END SERIAL
...
DO ITIME = 1, NTIME
  ...
  CALL CUCALLN_MF_MANYBLOCKS (PPLDARE, PPLRG, KSTEP, YDTHF, YDCST, YDERAD, YDML_PHY_SLIN, YDML_PHY_EC, &
      & YGFL, YDCHEM, YDSPP_CONFIG, YDPERTPAR, IIDIA, IFDIA, KLON, NGPBLKS, KSMAX, KLEV, PDX, KSPPN2D, &
      & LDMCAPEA, LDLAND, LDSLPHY, PTSPHY, PVDIFTS, PTM1, PQM1, PUM1, PVM1, PLITOT, PVERVEL, &
      & PQHFL, PAHFS, PAPHM1, PAP, PAPH, PGEO, PGEOH, PGAW, PCUCONVCA, PGP2DSPP, &
      & PTENT, PTENQ, PTENU, PTENV, PTENTA, PTENQA, PARPRC, KTOPC, KBASEC, KTYPE, &
      & KCBOT, KCTOP, KBOTSC, LDCUM, LDSC, KCBOT_LIG, KCTOP_LIG, LDCUM_LIG, LDSHCV, &
      & PLCRIT_AER, PLU, PLUDE, PLUDELI, PSNDE, PMFU, PMFD, PLGLAC, PDIFCQ, &
      & PDIFCS, PFHPCL, PFHPCN, PFPLCL, PFPLCN, PLRAIN, PRSUD, PSTRCU, PSTRCV, &
      & PFCQLF, PFCQIF, PMFUDE_RATE, PMFDDE_RATE, PCAPE, PWU, PWMEAN, PVDISCU, &
      & PDISS, KTRAC, PCM1, PTENC, PSCAV, PSCAV0=PSCAV0, LDACC=LLACC &
      & , YDSTACKBASE=YLSTACKBASE &
      &)
...
CALL YDPERTPAR%ACDC_WIPE ()
CALL YDSPP_CONFIG%ACDC_WIPE ()
CALL YDCHEM%ACDC_WIPE ()
CALL YGFL%ACDC_WIPE ()
CALL YDML_PHY_EC%ACDC_WIPE ()
CALL YDML_PHY_SLIN%ACDC_WIPE ()
CALL YDERAD%ACDC_WIPE ()
CALL YDCST%ACDC_WIPE ()
CALL YDTHF%ACDC_WIPE ()
...
CALL YDTHF%ACDC_LOAD (ILUNCI)
CALL YDCST%ACDC_LOAD (ILUNCI)
CALL YDERAD%ACDC_LOAD (ILUNCI)
CALL YDML_PHY_SLIN%ACDC_LOAD (ILUNCI)
CALL YDML_PHY_EC%ACDC_LOAD (ILUNCI)
CALL YGFL%ACDC_LOAD (ILUNCI)
CALL YDCHEM%ACDC_LOAD (ILUNCI)
CALL YDSPP_CONFIG%ACDC_LOAD (ILUNCI)
CALL YDPERTPAR%ACDC_LOAD (ILUNCI)
...
CALL YDTHF%ACDC_SAVE (ILUNCI)
CALL YDCST%ACDC_SAVE (ILUNCI)
CALL YDERAD%ACDC_SAVE (ILUNCI)
CALL YDML_PHY_SLIN%ACDC_SAVE (ILUNCI)
CALL YDML_PHY_EC%ACDC_SAVE (ILUNCI)
CALL YGFL%ACDC_SAVE (ILUNCI)
CALL YDCHEM%ACDC_SAVE (ILUNCI)
CALL YDSPP_CONFIG%ACDC_SAVE (ILUNCI)
CALL YDPERTPAR%ACDC_SAVE (ILUNCI)
