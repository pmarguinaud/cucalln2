...
IF (JL == 19 .AND. JK == 60) THEN
  PRINT *, " CUBIDIAG LD_LCUMASK = ", LD_LCUMASK(JL,JK)
ENDIF

    IF ( LD_LCUMASK(JL,JK) ) THEN

IF (JL == 19 .AND. JK == 60) THEN
  PRINT *, " CUBIDIAG KCTOP = ", KCTOP(JL)
ENDIF
...
IF (JL == 19 .AND. JK == 60) THEN
  PRINT *, " CUBIDIAG PR = ", PR(JL,JK)
  PRINT *, " CUBIDIAG PB = ", PB(JL,JK)
ENDIF
  ...
  ENDDO
ENDDO
IF (JL == 19) PRINT *, " CUBIDIAG PU = ", PU(JL,60)
