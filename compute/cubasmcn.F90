...
IF ((JL == 19) .AND. (KK == 78)) THEN
  PRINT *, " CUBASMCN KLAB ", KK+1, KLAB(JL,KK+1)
ENDIF
...
IF ((JL == 19) .AND. (KK == 78)) THEN
  PRINT *, " CUBASMCN LDCUM ", LDCUM (JL)
  PRINT *, " CUBASMCN KLAB ", KLAB(JL,KK+1)
ENDIF

  IF(.NOT.LDCUM(JL).AND.KLAB(JL,KK+1) == 0 ) THEN

IF ((JL == 19) .AND. (KK == 78)) THEN
  PRINT *, " CUBASMCN LMFMID = ", LMFMID
  PRINT *, " CUBASMCN NJKT7 = ", NJKT7
  PRINT *, " CUBASMCN PQEN = ", PQEN(JL,KK)
  PRINT *, " CUBASMCN PQSEN = ", PQSEN(JL,KK)
ENDIF
