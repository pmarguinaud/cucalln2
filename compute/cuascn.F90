...
IF (JL == 19) PRINT *, " CUASCN KTYPE ", KTYPE (JL)
...
IF ((JL==19).AND.(JK==78)) THEN
  PRINT *, " CUASCN KLAB ", JK+1, KLAB(JL,JK+1)
  PRINT *, " CUASCN PQSEN ", JK, PQSEN(JL,JK)
ENDIF
...
IF (JL == 19 .AND. JK == 78) PRINT *, " CUASCN KTYPE ", JK, KTYPE (JL)
