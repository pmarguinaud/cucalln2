...
LOGICAL :: LRADLWM, LRADLWM5, LTGWDWMSU, LTGWDWMSU5, LTGWDWMSV, LTGWDWMSV5, LYA5, LYI5, LYL5
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%YA5), CDPATH//'%YA5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%YL5), CDPATH//'%YL5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%YI5), CDPATH//'%YI5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RADLWM), CDPATH//'%RADLWM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RADLWM5), CDPATH//'%RADLWM5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TGWDWMSU), CDPATH//'%TGWDWMSU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TGWDWMSU5), CDPATH//'%TGWDWMSU5'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TGWDWMSV), CDPATH//'%TGWDWMSV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TGWDWMSV5), CDPATH//'%TGWDWMSV5'
