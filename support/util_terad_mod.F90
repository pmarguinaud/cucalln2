...
LOGICAL :: LCVDAEBC, LCVDAEDU, LCVDAEOM, LCVDAESS, LCVDAESU
WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NAER), CDPATH//'%NAER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMODE), CDPATH//'%NMODE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NOZOCL), CDPATH//'%NOZOCL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADFR), CDPATH//'%NRADFR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADPFR), CDPATH//'%NRADPFR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADPLA), CDPATH//'%NRADPLA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADINT), CDPATH//'%NRADINT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADRES), CDPATH//'%NRADRES'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADNFR), CDPATH//'%NRADNFR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADSFR), CDPATH//'%NRADSFR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADE1H), CDPATH//'%NRADE1H'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADE3H), CDPATH//'%NRADE3H'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADELG), CDPATH//'%NRADELG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NOVLP), CDPATH//'%NOVLP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRPROMA), CDPATH//'%NRPROMA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLW), CDPATH//'%NLW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWNL), CDPATH//'%NSWNL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWTL), CDPATH//'%NSWTL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTLW), CDPATH//'%NTLW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NTSW), CDPATH//'%NTSW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NUV), CDPATH//'%NUV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NCSRADF), CDPATH//'%NCSRADF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NINHOM), CDPATH//'%NINHOM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLAYINH), CDPATH//'%NLAYINH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLNGR1H), CDPATH//'%NLNGR1H'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NPERTAER), CDPATH//'%NPERTAER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NPERTOZ), CDPATH//'%NPERTOZ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSCEN), CDPATH//'%NSCEN'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NHINCSOL), CDPATH//'%NHINCSOL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMCICA), CDPATH//'%NMCICA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NGHGRAD), CDPATH//'%NGHGRAD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NVOLCVERT), CDPATH//'%NVOLCVERT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NREDGLW), CDPATH//'%NREDGLW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NREDGSW), CDPATH//'%NREDGSW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSPMAPL), CDPATH//'%NSPMAPL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSPMAPS), CDPATH//'%NSPMAPS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSW), CDPATH//'%NSW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWEMISS), CDPATH//'%NLWEMISS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NICEOPT), CDPATH//'%NICEOPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLIQOPT), CDPATH//'%NLIQOPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADIP), CDPATH//'%NRADIP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRADLP), CDPATH//'%NRADLP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWOUT), CDPATH//'%NLWOUT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDECOLAT), CDPATH//'%NDECOLAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMINICE), CDPATH//'%NMINICE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NAERMACC), CDPATH//'%NAERMACC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMCVAR), CDPATH//'%NMCVAR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWSCATTERING), CDPATH//'%NLWSCATTERING'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWSOLVER), CDPATH//'%NSWSOLVER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWSOLVER), CDPATH//'%NLWSOLVER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSOLARSPECTRUM), CDPATH//'%NSOLARSPECTRUM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDUMPBADINPUTS), CDPATH//'%NDUMPBADINPUTS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NDUMPINPUTS), CDPATH//'%NDUMPINPUTS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NCLOUDOVERLAP), CDPATH//'%NCLOUDOVERLAP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCLOUD_FRAC_STD), CDPATH//'%RCLOUD_FRAC_STD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCLOUD_SEPARATION_SCALE_TOA), CDPATH//'%RCLOUD_SEPARATION_SCALE_TOA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCLOUD_SEPARATION_SCALE_SURF), CDPATH//'%RCLOUD_SEPARATION_SCALE_SURF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LFU_LW_ICE_OPTICS_BUG), CDPATH//'%LFU_LW_ICE_OPTICS_BUG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LDIAGFORCING), CDPATH//'%LDIAGFORCING'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAPPROXLWUPDATE), CDPATH//'%LAPPROXLWUPDATE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAPPROXSWUPDATE), CDPATH//'%LAPPROXSWUPDATE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWICEOPT), CDPATH//'%NSWICEOPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWLIQOPT), CDPATH//'%NSWLIQOPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWICEOPT), CDPATH//'%NLWICEOPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWLIQOPT), CDPATH//'%NLWLIQOPT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LCCNL), CDPATH//'%LCCNL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LCCNO), CDPATH//'%LCCNO'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCCNLND), CDPATH//'%RCCNLND'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCCNSEA), CDPATH//'%RCCNSEA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RRE2DE), CDPATH//'%RRE2DE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RMINICE), CDPATH//'%RMINICE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMCLAT), CDPATH//'%NMCLAT'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMCLON), CDPATH//'%NMCLON'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NMCLEV), CDPATH//'%NMCLEV'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWGASOPTICS), CDPATH//'%NSWGASOPTICS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NLWGASOPTICS), CDPATH//'%NLWGASOPTICS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NGASOPTICSSCHEME), CDPATH//'%NGASOPTICSSCHEME'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%KMODTS), CDPATH//'%KMODTS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NSWWVCONTINUUM), CDPATH//'%NSWWVCONTINUUM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NRTCALL), CDPATH//'%NRTCALL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%IRTCALLREF), CDPATH//'%IRTCALLREF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%IRTCALLCLN), CDPATH//'%IRTCALLCLN'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LINTERPINCLOUDMEAN), CDPATH//'%LINTERPINCLOUDMEAN'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LERAD1H), CDPATH//'%LERAD1H'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LEPO3RA), CDPATH//'%LEPO3RA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LONEWSW), CDPATH//'%LONEWSW'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LECSRAD), CDPATH//'%LECSRAD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LRRTM), CDPATH//'%LRRTM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LSRTM), CDPATH//'%LSRTM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LDIFFC), CDPATH//'%LDIFFC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LHVOLCA), CDPATH//'%LHVOLCA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LNEWAER), CDPATH//'%LNEWAER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LNOTROAER), CDPATH//'%LNOTROAER'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LRAYL), CDPATH//'%LRAYL'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LOPTRPROMA), CDPATH//'%LOPTRPROMA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LECO2VAR), CDPATH//'%LECO2VAR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LHGHG), CDPATH//'%LHGHG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LESO4HIS), CDPATH//'%LESO4HIS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LETRACGMS), CDPATH//'%LETRACGMS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAERCLIM), CDPATH//'%LAERCLIM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAERVISI), CDPATH//'%LAERVISI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAER3D), CDPATH//'%LAER3D'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LVOLCSPEC), CDPATH//'%LVOLCSPEC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LVOLCDAMP), CDPATH//'%LVOLCDAMP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAERADCLI), CDPATH//'%LAERADCLI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAERADJDU), CDPATH//'%LAERADJDU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LMANNERSSWUPDATE), CDPATH//'%LMANNERSSWUPDATE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LCENTREDTIMESZA), CDPATH//'%LCENTREDTIMESZA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LAVERAGESZA), CDPATH//'%LAVERAGESZA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LECOMPGRID), CDPATH//'%LECOMPGRID'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LUSEPRE2017RAD), CDPATH//'%LUSEPRE2017RAD'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LDUSEASON), CDPATH//'%LDUSEASON'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LPERPET), CDPATH//'%LPERPET'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LCLEAN), CDPATH//'%LCLEAN'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAOVLP), CDPATH//'%RAOVLP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RBOVLP), CDPATH//'%RBOVLP'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LEDBUG), CDPATH//'%LEDBUG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RPERTOZ), CDPATH//'%RPERTOZ'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RLWINHF), CDPATH//'%RLWINHF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RSWINHF), CDPATH//'%RSWINHF'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RVOLCSPEC), CDPATH//'%RVOLCSPEC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RNS), CDPATH//'%RNS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RSIGAIR), CDPATH//'%RSIGAIR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAESHSS), CDPATH//'%RAESHSS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAESHDU), CDPATH//'%RAESHDU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAESHOM), CDPATH//'%RAESHOM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAESHBC), CDPATH//'%RAESHBC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RAESHSU), CDPATH//'%RAESHSU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%TRBKG), CDPATH//'%TRBKG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%STBKG), CDPATH//'%STBKG'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CGHGCLIMFILE), CDPATH//'%CGHGCLIMFILE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CGHGTIMESERIESFILE), CDPATH//'%CGHGTIMESERIESFILE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CSOLARIRRADIANCEFILE), CDPATH//'%CSOLARIRRADIANCEFILE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RRATSEA), CDPATH//'%RRATSEA'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RRATLAND), CDPATH//'%RRATLAND'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RRATDRI), CDPATH//'%RRATDRI'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCADECOR), CDPATH//'%RCADECOR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RCBDECOR), CDPATH//'%RCBDECOR'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%RFACDICE), CDPATH//'%RFACDICE'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CVDAESS), CDPATH//'%CVDAESS'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CVDAEDU), CDPATH//'%CVDAEDU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CVDAEOM), CDPATH//'%CVDAEOM'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CVDAEBC), CDPATH//'%CVDAEBC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CVDAESU), CDPATH//'%CVDAESU'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%CECRADARCH), CDPATH//'%CECRADARCH'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%LECRADACC), CDPATH//'%LECRADACC'

WRITE (KLUN, '(Z16.16," ",A)') CRC64 (YD%NECRADLEN), CDPATH//'%NECRADLEN'
