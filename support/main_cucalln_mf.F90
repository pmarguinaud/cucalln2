...
INTEGER*8 :: YLSTACK_L4, YLSTACK_L8
...
!$OMP PARALLEL DO PRIVATE (JBLK, JLON, YLSTACK)
    DO JBLK = 1, NGPBLKS
      DO JLON = 1, NPROMA
        ...
        & PFCQIF (:, :, JBLK), PMFUDE_RATE (:, :, JBLK), PMFDDE_RATE (:, :, JBLK), PCAPE (:, JBLK), PWU (:, :, JBLK),   &
        & PWMEAN (:, JBLK), PVDISCU (:, JBLK), PDISS (:, :, JBLK), KTRAC, PCM1 (:, :, :, JBLK), PTENC (:, :, :, JBLK),  &
        & PSCAV, PSCAV0, YDSTACK_L4=YLSTACK%L4, YDSTACK_L8=YLSTACK%L8)
...
!$ACC&VECTOR_LENGTH (NPROMA)
    DO JBLK = 1, NGPBLKS
!$ACC LOOP VECTOR &
!$ACC&PRIVATE (JLON, YLSTACK_L4, YLSTACK_L8) 
    
      DO JLON = 1, NPROMA
    
        YLSTACK_L4 = stack_l4 (YSTACK, JBLK, NGPBLKS)
        YLSTACK_L8 = stack_l8 (YSTACK, JBLK, NGPBLKS)
        ...
        & PFCQIF (:, :, JBLK), PMFUDE_RATE (:, :, JBLK), PMFDDE_RATE (:, :, JBLK), PCAPE (:, JBLK), PWU (:, :, JBLK),   &
        & PWMEAN (:, JBLK), PVDISCU (:, JBLK), PDISS (:, :, JBLK), KTRAC, PCM1 (:, :, :, JBLK), PTENC (:, :, :, JBLK),  &
        & PSCAV, PSCAV0, YDSTACK_L4=YLSTACK_L4, YDSTACK_L8=YLSTACK_L8)
